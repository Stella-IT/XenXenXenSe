...
async def vif_get_ipv4_by_uuid(cluster_id: str, vif_uuid: str, address: IPAddressModel):
...
async def vif_get_ipv4_by_uuid(cluster_id: str, vif_uuid: str, addresses: IPAddressesModel):
