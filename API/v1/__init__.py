...
router.include_router(_host_list, prefix=_prefix, tags=['_host'])
router.include_router(_host_info, prefix=_prefix, tags=['_host'])

router.include_router(_vm_clone, prefix=_prefix, tags=['_vm'])
router.include_router(_vm_cd, prefix=_prefix, tags=['_vm'])
router.include_router(_vm_console, prefix=_prefix, tags=['_vm'])
router.include_router(_vm_delete, prefix=_prefix, tags=['_vm'])
router.include_router(_vm_guest, prefix=_prefix, tags=['_vm'])
router.include_router(_vm_list, prefix=_prefix, tags=['_vm'])
router.include_router(_vm_info, prefix=_prefix, tags=['_vm'])
router.include_router(_vm_metadata, prefix=_prefix, tags=['_vm'])
router.include_router(_vm_platform, prefix=_prefix, tags=['_vm'])
router.include_router(_vm_power, prefix=_prefix, tags=['_vm'])
router.include_router(_vm_specs, prefix=_prefix, tags=['_vm'])
router.include_router(_vm_vbd, prefix=_prefix, tags=['_vm'])
router.include_router(_vm_vif, prefix=_prefix, tags=['_vm'])
router.include_router(_vm_bios, prefix=_prefix, tags=['_vm'])
